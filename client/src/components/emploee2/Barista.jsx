    ...
    <div className="rounded-lg bg-slate-50 p-6 shadow-md">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          {orders.length > 0 ? (
            <div className="grid grid-cols-1 gap-4 rounded-md border border-blue-100 bg-blue-50 p-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {orders.map(
                (order, i) =>
                  !order.ready && (
                    <div
                      key={order.number}
                      className="rounded-lg border border-blue-300 bg-white p-4 shadow-sm duration-200 hover:shadow-md"
                    >
